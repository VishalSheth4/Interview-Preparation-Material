...
//
//Management :-
//WeLoveBooks is a library of books. Each book is identified by ISBN number and has a title. To be a member of a library a person needs to register with the library using his telephone number.
//Telephone number must be unique. A person cannot loan more than 6 books.
//
//Requirement
//You need to develop an application which manages members, manages books and manages loaning of books. Ul for this is application is implemented by a different team.
